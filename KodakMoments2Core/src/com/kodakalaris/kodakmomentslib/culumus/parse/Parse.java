...
import com.kodakalaris.kodakmomentslib.culumus.bean.content.Theme.BackGround;
...
import com.kodakalaris.kodakmomentslib.culumus.bean.storelocator.StoreInfo.StoreHour;
...
public class Parse {
	...
	public AuthorizationToken parseAuthorizationToken(String result) throws WebAPIException{
		checkError(result);
	...
	public List<Retailer> parseRetailers(String result) throws WebAPIException{
		checkError(result);
	...
	public List<Catalog> parseCatalogs(String types, String result) throws WebAPIException{
		checkError(result);
	...
	public LinkedHashMap<String, String> parseCountries(String result) throws WebAPIException{
		checkError(result);
	...
	public List<CountryInfo> parseCountryInfo(String result) throws WebAPIException{
		checkError(result);
	...
	public List<Theme> parseThemes(String result) throws WebAPIException{
		checkError(result);
	...
	public List<ColorEffect> parseColorEffects(String result) throws WebAPIException{
		checkError(result);
	...
	public TextBlock parseTextBlock(String result) throws WebAPIException{
		checkError(result);
		try{
			JSONObject jsObj = new JSONObject(result);
	...
	public List<TextBlock> parseTextBlocks(String result) throws WebAPIException {
	...
	public List<KMConfig> parseConfigs(String result) throws WebAPIException {
		List<KMConfig> configs = null;
		try {
			JSONObject jsObj = new JSONObject(result);
			JSONArray jsConfigs = jsObj.getJSONArray(KMConfig.FLAG_CONFIG);
			configs = new ArrayList<KMConfig>();
			for(int i=0; i<jsConfigs.length(); i++){
				KMConfig config = parseConfig(jsConfigs.getJSONObject(i));
				configs.add(config);
			}
		} catch (JSONException e) {
			e.printStackTrace();
	...
	private KMConfig parseConfig(JSONObject jsConfig) throws JSONException{
		KMConfig config = new KMConfig();
		config.id = jsConfig.optString(KMConfig.FLAG_CONFIG_ID);
		config.configData = parseConfigData(jsConfig.optJSONObject(KMConfig.FLAG_CONFIG_DATA));
		return config;
	}
	
	private KMConfigData parseConfigData(JSONObject jsData) throws JSONException{
		KMConfigData data = new KMConfigData();
		data.id = jsData.optString(KMConfigData.FLAG_ID);
		data.entries = parseConfigEntries(jsData.optJSONArray(KMConfigData.FLAG_ENTRIES));
		return data;
	}
	
	private List<KMConfigEntry> parseConfigEntries(JSONArray jsEntries) throws JSONException{
		List<KMConfigEntry> entries = new ArrayList<KMConfigEntry>();
		for(int i=0; i<jsEntries.length(); i++){
			KMConfigEntry entry = new KMConfigEntry();
			JSONObject jsEntry = jsEntries.getJSONObject(i);
			entry.actionText = jsEntry.optString(KMConfigEntry.FLAG_Localized_Action_Text);
			entry.action = jsEntry.optString(KMConfigEntry.FLAG_Action);
			entry.title = jsEntry.optString(KMConfigEntry.FLAG_Localized_Title);
			entry.subtitle = jsEntry.optString(KMConfigEntry.FLAG_Localized_Subtitle);
			entry.imageUrl = jsEntry.optString(KMConfigEntry.FLAG_ImageURL);
			entries.add(entry);
		}
		return entries;
	}
	
	public List<StoreInfo> parseStoresInfo(String result) throws WebAPIException{
		checkError(result);
	...
	public Resource parseResource(String result) throws WebAPIException{
		checkError(result);
		Resource res = null;
		try {
			JSONObject jsObj = new JSONObject(result);
	...
	public ImageResource parseImageResource(String result) throws WebAPIException{
		checkError(result);
	...
	public ImageResource parseImageResource(String result,boolean isUseUrl) throws WebAPIException{
		checkError(result);
	...
	public String parseImage(String result) throws WebAPIException{
		checkError(result);
	...
	public Pricing parsePricing(String result) throws WebAPIException{
		checkError(result);
	...
	public Pricing parsePricing3(String result) throws WebAPIException{
		checkError(result);
		Pricing pricing = null;
		try {
			JSONObject jsObj = new JSONObject(result);
	...
	public Cart parseCart(String result) throws WebAPIException{
		checkError(result);
		Cart cart = null;
		try {
			JSONObject jsObj = new JSONObject(result);
	...
	public CartItem[] parseCartItems(String result) throws WebAPIException{
		checkError(result);
		CartItem[] items = null;
		try {
			JSONObject jsObj = new JSONObject(result);
	...
	public Placeholders parsePlaceholders(String result) throws WebAPIException {
		checkError(result);
		
		Placeholders holders = null;
		try {
			JSONObject jsObj = new JSONObject(result);
			JSONObject jsPlaceholders = jsObj.getJSONObject(Placeholders.FLAG_PLACEHOLDERS);
			
			holders = new Placeholders();
			holders.baseURI = jsPlaceholders.getString(Placeholders.FLAG_BASE_URI);
			
			JSONArray arrIds = jsPlaceholders.getJSONArray(Placeholders.FLAG_IDS);
			
			holders.ids = new ArrayList<String>();
			for (int i = 0; i < arrIds.length(); i++) {
				holders.ids.add(arrIds.getString(i));
			}
	...
	protected List<Layer> parseLayers(JSONArray jsonLayers,int length){
		try{
	...
	public Layer parseLayer(String result) throws WebAPIException {
		checkError(result);
		Layer layer = null;
		try {
	...
	public List<ServerPhoto> parseServerPhotos(String result) throws WebAPIException {
	...
	public NewOrder parseNewOrder(String result) throws WebAPIException{
		checkError(result);
	...
	public Boolean parseStoreAvailability(String result) throws WebAPIException{
		checkError(result);
	...
	public ROI parseROI(String result) throws WebAPIException{
		checkError(result);
		ROI roi = null;
		try {
			JSONObject jsObj = new JSONObject(result);
	...
	public ProjectSearchResult parseProjectsSearchResult(String result) throws WebAPIException{
		checkError(result);
	...
	public Project parseProject(String result) throws WebAPIException{
		checkError(result);
	...
	public void checkError(String result) throws WebAPIException{
		...
		try {
			...
			if(jsObj.has(ERROR)){
				...
				if(jsResult.equals("null")){
					...
					throw WebAPIException.server(jsError.getString("ErrorCode"), jsError.toString());
				}
			}
		} catch (JSONException e) {
			e.printStackTrace();
			throw WebAPIException.server("", result);
		}
	}
}
