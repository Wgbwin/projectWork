...
public class LocationService {
	...
	/**
	 * net and gps location. note: when gps locate successful,
	 * LocationListener's onLocationChanged method will be invoked.
	 * 
	...
	/**
	 * For the reason that people usually do the work when is on location
	 * changed, so it's simple and easy define an interface with one function
	 * 
	 * @author bigtotoro
	 */
