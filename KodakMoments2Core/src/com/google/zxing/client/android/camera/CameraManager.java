...
public final class CameraManager
{
	...
	public Rect getFramingRect()
	{
		if (framingRect == null)
		{
			...
			int height = screenResolution.y * 630 / 1920;
			int width = height;
...
//			}
			...
			int actionbarHeight = KM2Application.getInstance().getResources().getDimensionPixelSize(R.dimen.actionbar_height);
			int topOffset = (screenResolution.y - actionbarHeight - height) / 2;
			topOffset += 40;
			framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset - 80 + height);
