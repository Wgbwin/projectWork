...
public final class ViewfinderView extends View
{
	...
	public ViewfinderView(Context context, AttributeSet attrs)
	{
		...
		maskColor = resources.getColor(R.color.black_60alpha);
		resultColor = resources.getColor(R.color.result_view);
		frameColor = resources.getColor(R.color.viewfinder_frame);
		laserColor = resources.getColor(R.color.kodak_red);
...
//			canvas.drawRect(frame.left, frame.top, frame.right + 1, frame.top + 6, paint);
//			canvas.drawRect(frame.left, frame.top + 6, frame.left + 6, frame.bottom - 1, paint);
...
//			scannerAlpha = (scannerAlpha + 1) % SCANNER_ALPHA.length;
			...
			canvas.drawRect(frame.left - 107, middle - 1, frame.right + 107, middle + 2, paint);
