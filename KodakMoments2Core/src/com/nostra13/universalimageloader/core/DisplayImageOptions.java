...
public final class DisplayImageOptions {
	...
	private DisplayImageOptions(Builder builder) {
		...
		roiWithRotateDegree = builder.roiWithRotateDegree;
	}
	...
	public ROIWithRotateDegree getRoi() {
		return roiWithRotateDegree;
	}
	...
	public static class Builder {
		...
		private ROIWithRotateDegree roiWithRotateDegree = null;
		...
		public Builder roi(ROIWithRotateDegree roiWithRotateDegree){
		...
		public Builder cloneFrom(DisplayImageOptions options) {
			...
			roiWithRotateDegree = options.roiWithRotateDegree;
			return this;
		}
