...
public class CalendarParse extends Parse {
	...
	public List<CalendarTheme> parseCalendarThemes(String result,String productDescriptionId) throws RssWebServiceException{
		checkError(result);
	...
	public Calendar parseCalendar(String result) throws RssWebServiceException{
		checkError(result);
	...
	public CalendarPage[] parseCalendarPages(String result) throws RssWebServiceException{
		checkError(result);
	...
	public CalendarPage parseCalendarPage(String result)throws RssWebServiceException{
		checkError(result);
		try {
	...
	private CalendarLayer[] parseCalendarLayer(JSONArray jsonLayers){
		try{
			CalendarLayer[] layers = null;
			if(jsonLayers != null){
				layers = new CalendarLayer[jsonLayers.length()];
	...
	public List<CalendarContent> parseCalendarContents(String result) throws RssWebServiceException{
		checkError(result);
