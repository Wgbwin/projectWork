...
import com.kodak.rss.core.n2r.bean.calendar.CalendarContent;
...
import com.kodak.rss.core.n2r.parse.CalendarParse;

public class CalendarWebService extends WebService{

	private CalendarParse mCalendarParse;
	
	public CalendarWebService(Context context) {
		super(context);
		mCalendarParse = new CalendarParse();
	}
	
	public List<CalendarTheme> getCalendarsTask(String productDescriptionId,String language) throws RssWebServiceException {
		int count = 0;		
	...
	public Calendar createCalendarTask(String productDescriptionId,String contentId,String language) throws RssWebServiceException {
		int count = 0;
	    ...
	    String useCountry = RssApp.getInstance().getCountrycodeCurrentUsed(); 
	...
	public Calendar getCalendarTask(String calendarId) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage addContentToCalendarPageTask(String pageId, List<String> contentIds) throws RssWebServiceException {
		int count = 0;		
	...
	public CalendarPage removeContentInCalendarPageTask(String pageId,String contentId) throws RssWebServiceException {	
		int count = 0;	
	...
	public CalendarPage getCalendarPageTask(String pageId) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage swapContentInCalendarTask(String pageId,String contentId1,String contentId2) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage swapContent2InCalendarTask(String pageId,int holeIndex1,int holeIndex2) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage[] addContentToCalendarGridsTask(String calendarId,List<CalendarGridItemPO> gridItemPos) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage[] addTextToCalendarGridsTask(String calendarId,List<CalendarGridItemPO> gridItemPos) throws RssWebServiceException {
		int count = 0;
	...
	public List<CalendarContent> getCalendarContentsTask(String calendarId) throws RssWebServiceException {
		int count = 0;		
	...
	public TextBlock getTextBlockForPage(String pageId,boolean isForCalendarGrid) throws RssWebServiceException {	
		int count = 0;		
	...
	public CalendarPage layoutPageInCalendarTask(String pageId) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage insertContentOnPageTask(String pageId,int holeIndex,String contentId) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage shuffleContentCalendarPageTask(String pageId) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage[] setCalendarTitleTask(String calendarId,String title) throws RssWebServiceException {
		int count = 0;
	...
	public CalendarPage[] setCalendarAuthorTask(String calendarId,String author) throws RssWebServiceException {
		int count = 0;
