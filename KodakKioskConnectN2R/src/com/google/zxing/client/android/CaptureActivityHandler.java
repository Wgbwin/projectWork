...
public final class CaptureActivityHandler extends Handler
{
	...
	public void handleMessage(Message message)
	{
		if (message.what == R.id.auto_focus) {
			...
			Intent intent = new Intent(activity, WiFiConnectionActivity.class);
			activity.finish();
			activity.startActivity(intent);
		} else if (message.what == 20) {
			if(activity != null && activity.takingtoolong!= null && activity.manualConnectButton!=null)
			{
				activity.takingtoolong.setVisibility(View.VISIBLE);
				activity.manualConnectButton.setVisibility(View.VISIBLE);
			}
		}
	}
