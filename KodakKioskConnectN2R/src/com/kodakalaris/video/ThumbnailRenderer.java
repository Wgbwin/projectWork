...
/**
 * This AsyncTask loads Bitmaps on a background thread.
 * It holds weak references to views, and can update a progress
 * spinner if required.
 * 
 * This also adds rendered bitmaps to the bitmap cache.
 */
