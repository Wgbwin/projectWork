...
//                            mReusableBitmaps.add(new SoftReference<Bitmap>(oldValue.getBitmap()));
    ...
    public static class ImageCacheParams {
        ...
        public void setMemCacheSizePercent(float percent) {
           ...
           int  memCacheSizeTemp = Math.round(percent * Runtime.getRuntime().maxMemory() / 1024);
           if(memCacheSizeTemp < DEFAULT_MEM_CACHE_SIZE){
        	   memCacheSize = memCacheSizeTemp ;
           }else {
        	   memCacheSize = DEFAULT_MEM_CACHE_SIZE ;
           }
    ...
    private static boolean canUseForInBitmap(
		...
		try {
			...
			Method method = c.getDeclaredMethod("getAllocationByteCount") ;
			
			allocationByteCount = (Integer) method.invoke(candidate);
    ...
    public static int getBitmapSize(BitmapDrawable value) {
        ...
        if (Utils.hasKitKat()) {
        	 int allocationByteCount = 0;
     		try {
     			Class<?> c = bitmap.getClass() ;
     			
     			Method method = c.getDeclaredMethod("getAllocationByteCount") ;
     			
     			allocationByteCount = (Integer) method.invoke(bitmap);
     		} catch (IllegalArgumentException e) {
     			// TODO Auto-generated catch block
     			e.printStackTrace();
     		} catch (NoSuchMethodException e) {
