 ...
 */
public abstract class ImageWorkerTN {
    ...
    protected ImageWorkerTN(Context context) {
        mContext = context;
    }
     ...
     * {@link ImageWorkerTN#setImageCache(ImageCache)}. If the image is found in the memory cache, it
     ...
     * {@link ImageWorkerTN#setImageCache(ImageCache)}. If the image is found in the memory cache, it
     * is set immediately, otherwise an {@link AsyncTask} will be created to asynchronously load the
     * bitmap. {@link ImageWorkerTN#setAdapter(ImageWorkerAdapter)} must be called before using this
     * method.
     *
     * @param data The URL of the image to download.
     * @param imageView The ImageView to bind the downloaded image to.
    ...
    public void setLoadingImage(int resId) {
        ...
        mLoadingBitmap = PrintHelper.readBitMap(mContext, resId);
    }
     ...
     *            {@link ImageWorkerTN#loadImage(Object, ImageView)}
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
        	...
        	//if set to ture,load thumbnails thread will be interruprted and maybe return null result.
