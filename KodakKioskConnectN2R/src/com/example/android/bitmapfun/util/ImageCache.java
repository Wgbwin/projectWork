...
public class ImageCache {
    ...
    private static final int DEFAULT_MEM_CACHE_SIZE = 1024 * 1024 * 3; // 5MB
    ...
    public static ImageCache currentCache(final FragmentActivity activity, ImageCacheParams cacheParams)
    {
        // Search for, or create an instance of the non-UI RetainFragment
        final RetainFragment mRetainFragment = RetainFragment.findOrCreateRetainFragment(
                activity.getSupportFragmentManager());
    ...
    public void replaceBitmapInCache(String data, Bitmap bitmap)
    {
