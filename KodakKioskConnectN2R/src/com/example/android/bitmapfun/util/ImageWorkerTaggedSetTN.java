 ...
 */
public abstract class ImageWorkerTaggedSetTN {
    ...
    protected ImageWorkerTaggedSetTN(Context context) {
        mContext = context;
    }

    /**
     * Load an image specified by the data parameter into an ImageView (override
     * {@link ImageWorkerTaggedSetTN#processBitmap(Object)} to define the processing logic). A memory and disk
     * cache will be used if an {@link ImageCache} has been set using
     * {@link ImageWorkerTaggedSetTN#setImageCache(ImageCache)}. If the image is found in the memory cache, it
     ...
     * {@link ImageWorkerTaggedSetTN#setImageCache(ImageCache)}. If the image is found in the memory cache, it
     * is set immediately, otherwise an {@link AsyncTask} will be created to asynchronously load the
     * bitmap. {@link ImageWorkerTaggedSetTN#setAdapter(ImageWorkerAdapter)} must be called before using this
     * method.
     *
     * @param data The URL of the image to download.
     * @param imageView The ImageView to bind the downloaded image to.
     ...
     *            {@link ImageWorkerTaggedSetTN#loadImage(Object, ImageView)}
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            ...
            // the cache
            String fileName = Utils.getFilePath(dataString, mContext);
     ...
     *
     * @param imageselectionthumbworkerurlsadapter
     */
    public void setAdapter(ImageWorkerAdapter imageselectionthumbworkerurlsadapter) {
        mImageWorkerAdapter = imageselectionthumbworkerurlsadapter;
    }
