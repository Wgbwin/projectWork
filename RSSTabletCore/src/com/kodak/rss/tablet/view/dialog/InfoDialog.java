...
public class InfoDialog extends Dialog{
	...
	public static class Builder{
		...
		private boolean changePositiveButtonBackground = false;
		private boolean changeMessageGravity = false;
		...
		public Builder setMessage(CharSequence message, boolean changeGravity){
			setMessage(message);
			changeMessageGravity = changeGravity;
			return this;
		}
		...
		public Builder setMessage(int messageId, boolean changeGravity){
			return setMessage(context.getText(messageId), changeGravity);
		}
		 ...
		 * @param text
		 * @param onClickListener
		 * @param changeBackgournd
		 * @return
		 */
		public Builder setPositiveButton(CharSequence text,OnClickListener onClickListener, boolean changeBackgournd){
			setPositiveButton(text, onClickListener);
			this.changePositiveButtonBackground = changeBackgournd;
			return this;
		}
		 ...
		 * @return
		 */
		public Builder setPositiveButton(int textId,OnClickListener onClickListener, boolean changeBackgournd){
			return setPositiveButton(context.getText(textId), onClickListener, changeBackgournd);
		}
		...
		public InfoDialog create(){
			final InfoDialog dialog = new InfoDialog(context, R.style.SimpleDialogTheme);
			View v = LayoutInflater.from(context).inflate(R.layout.info_dialog,null);
			...
			if(positiveButtonText != null){
				...
				if(changePositiveButtonBackground){
					btnPositive.setBackgroundResource(R.drawable.cart_button);
				}
