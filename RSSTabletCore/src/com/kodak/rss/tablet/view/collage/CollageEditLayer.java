...
public class CollageEditLayer extends RelativeLayout{
	private static final String TAG = "CollageEditLayer";
	...
	public CollageEditLayer(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setOnPopEditItemClickListener(OnEditItemClickListener<CollageEditPopView, CollagePage, CollageLayer> onEditItemClickListener){
		...
		pop.setOnDoneClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(onDoneClickListener != null){
					onDoneClickListener.OnDoneClick(CollageEditLayer.this,pageView,ivEdit);
				}else{
					dismiss();
				}
			}
	...
	public void showEditImageAndPop(final CollagePageView pageView, CollageLayer layer, RectF layerRect){
		dismissEditProgress();
	...
	public void showEditImageAndPop(final CollagePageView pageView,final CollageLayer layer){
	...
	private void showLayerDownloadProgress(final CollagePage page, final Layer layer){
	...
	public static interface OnDoneClickListener{
		 ...
		 * @param ivEdit
		 */
		void OnDoneClick(CollageEditLayer editLayer, CollagePageView pageView, EditImageView ivEdit);
	}
	
	private void showEditImage(final CollagePageView pageView, final Layer layer,
	...
	private void showEditImagePop(CollagePageView pageView, CollageLayer layer, RectF layerRect){
	...
	private void setImageEditLayout(CollagePageView pageView, Layer layer, RectF layerRect){
	...
	private void setImageEditPopLayout(CollagePageView pageView, Layer layer,RectF layerRect){
		int[] pageViewLocation = new int[2];
