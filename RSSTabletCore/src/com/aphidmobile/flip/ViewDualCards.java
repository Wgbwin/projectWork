...
public class ViewDualCards {
  ...
  synchronized boolean loadView(int index, View view, Bitmap.Config format, Drawable bgDrawable, int[] offsets) {
    ...
    if (view != null) {
      ...
      recycleScreenshot();
      screenshot = GrabIt.takeScreenshot(view, format,bgDrawable,offsets);
    } else {
      recycleScreenshot();
    }
