    ...
    switch (bitmap.getConfig()) {
      ...
      case RGB_565:
        gl.glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, potW, potH, 0, GL_RGB, GL_UNSIGNED_SHORT_5_6_5,
                        null);
        //If the width is not multiply 8, the image will be skewd
        //You can set GL10.GL_UNPACK_ALIGNMENT to avoid this issue, but it will cost more cpu to do it.
        //Here our screenshot width is all mutiply 4
